      ...
      <form
        onSubmit={(e) => {
          ...
          toast.promise(new Promise((resolve) => setTimeout(resolve, 1000)), {
            loading: `A guardar ${row.original.header}`,
            success: 'Concluído',
            error: 'Erro',
          });
        }}
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          <SelectTrigger className="flex w-fit @4xl/main:hidden" size="sm" id="view-selector">
            <SelectValue placeholder="Selecionar uma vista" />
          </SelectTrigger>
          <SelectContent>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm">
            <Plus />
            <span className="hidden lg:inline">Adicionar Secção</span>
          </Button>
        </div>
      </div>
      <TabsContent
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Tendência de subida de 5,2% este mês <TrendingUp className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  Total de visitantes nos últimos 6 meses. Este é apenas um texto de exemplo para
                  testar o layout. Ocupa várias linhas e deve ajustar-se automaticamente.
                </div>
              </div>
              <Separator />
            </>
