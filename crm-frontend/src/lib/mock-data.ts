...
const initialCustomers: Customer[] = [
  ...
  },
  {
    id: 3,
    name: 'Michael Chen',
    email: 'mchen@cloudventures.com',
    phone: '+1 (555) 345-6789',
    company: 'CloudVentures Inc',
    nif: null,
    iban: null,
    decisor: null,
    segment: null,
  ...
  },
  {
    id: 6,
    name: 'Lisa Anderson',
    email: 'l.anderson@bizpro.com',
    phone: '+1 (555) 678-9012',
    company: 'BizPro Consulting',
    nif: null,
    iban: null,
    decisor: null,
    segment: null,
  ...
  },
  {
    id: 8,
    name: 'Maria Garcia',
    email: 'maria.g@globalsoft.com',
    phone: '+1 (555) 890-1234',
    company: 'GlobalSoft Industries',
    nif: null,
    iban: null,
    decisor: null,
    segment: null,
  ...
  },
  {
    ...
    email: 'c.brown@primeware.com',
    phone: '+1 (555) 111-2222',
    company: 'PrimeWare Solutions',
    nif: null,
    iban: null,
    decisor: null,
    segment: null,
  ...
  },
  {
    id: 13,
    name: 'Daniel Kim',
    email: 'dkim@horizonsoft.com',
    phone: '+1 (555) 333-4444',
    company: 'HorizonSoft Inc',
    nif: null,
    iban: null,
    decisor: null,
    segment: null,
...
const initialServices: Service[] = [
  ...
  },
  {
    id: 4,
    name: 'Starter Annual',
    description: 'Starter plan with annual billing',
    price: 299.99,
    billingCycle: 'yearly',
    status: 'active',
    features: ['5 Users', '10GB Storage', 'Email Support', 'Basic Analytics', '2 Months Free'],
    createdAt: '2024-01-01T00:00:00Z',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    billingCycle: 'monthly',
    status: 'active',
    features: ['1 User', '1GB Storage', 'Email Support'],
    createdAt: '2024-01-01T00:00:00Z',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    billingCycle: 'monthly',
    status: 'inactive',
    features: ['10 Users', '25GB Storage', 'Email Support', 'Basic Analytics'],
...
const initialEvents: Event[] = [
  {
    ...
    entityType: 'customer',
    entityId: 1,
    description: 'Customer John Smith was created',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'service',
    entityId: 2,
    description: 'Professional Plan price was updated',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityId: 1,
    description: 'New notification sent to John Smith',
    performedBy: 'System',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 99,
    description: 'Customer Test User was deleted',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 4,
    description: 'Customer Emily Rodriguez status changed to inactive',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'service',
    entityId: 7,
    description: 'New service Team Plan was created',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 2,
    description: 'Payment received from Sarah Johnson - $799.99',
    performedBy: 'System',
  ...
  },
  {
    ...
    entityType: 'system',
    entityId: 0,
    description: 'Customer report exported to CSV',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 15,
    description: 'Customer Ryan Thompson was created',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'service',
    entityId: 3,
    description: 'Enterprise Plan was activated',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 5,
    description: 'Customer David Park contact info updated',
    performedBy: 'Admin',
  ...
  },
  {
    ...
    entityType: 'notification',
    entityId: 8,
    description: 'Monthly report notification sent',
    performedBy: 'System',
...
const initialCustomerServices: CustomerService[] = [
  ...
  },
  {
    ...
    customerId: 3,
    acesso: 'ACC-004',
    tarifario: 'Empresarial Standard',
    operadora: 'MEO',
    valor: 35.0,
    moeda: 'EUR',
    conta: 'CT-10003',
    ...
    numServico: 'NS-8005',
    morada: '',
    observacoes: 'Cliente com desconto fidelização',
    createdAt: '2024-03-10T09:15:00Z',
  },
  {
    id: 6,
    ...
    numServico: 'NS-8006',
    morada: '',
    observacoes: 'VIP - suporte prioritário',
    createdAt: '2024-04-05T11:00:00Z',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    numServico: 'NS-8008',
    morada: '',
    observacoes: 'Integração com sistemas existentes',
    createdAt: '2024-03-22T13:45:00Z',
  },
];
...
const initialCustomerNotes: CustomerNote[] = [
  {
    ...
    customerId: 1,
    content:
      'Initial meeting went well. Customer is interested in scaling their team next quarter.',
    createdBy: 'Admin',
  ...
  },
  {
    id: 2,
    customerId: 1,
    content: 'Follow-up call scheduled for next week to discuss enterprise features.',
    createdBy: 'Admin',
  ...
  },
  {
    id: 3,
    customerId: 1,
    content: 'Customer requested API documentation. Sent via email.',
    createdBy: 'Support',
  ...
  },
  {
    id: 4,
    customerId: 2,
    content: 'Onboarding completed successfully. Team is very responsive.',
    createdBy: 'Admin',
  ...
  },
  {
    id: 6,
    customerId: 3,
    content: 'Customer experiencing some performance issues. Engineering team investigating.',
    createdBy: 'Support',
  ...
  },
  {
    id: 7,
    customerId: 3,
    content: 'Performance issues resolved. Customer satisfied with response time.',
    createdBy: 'Support',
  ...
  },
  {
    id: 8,
    customerId: 5,
    content: 'VIP customer - ensure priority support for all requests.',
    createdBy: 'Admin',
  ...
  },
  {
    id: 9,
    customerId: 6,
    content: 'Customer interested in annual billing discount.',
    createdBy: 'Sales',
  ...
  },
  {
    id: 10,
    customerId: 7,
    content: 'Technical onboarding completed. Integration with their existing systems successful.',
    createdBy: 'Support',
...
const initialCustomerDocuments: CustomerDocument[] = [
  ...
  },
  {
    ...
    size: 89000,
    url: '#',
    uploadedAt: '2024-02-22T11:00:00Z',
  },
  {
    id: 6,
    customerId: 3,
  ...
  },
  {
    ...
    size: 245000,
    url: '#',
    uploadedAt: '2024-02-14T08:30:00Z',
  },
  {
    id: 10,
    customerId: 7,
    name: 'Integration Specs.pdf',
    type: 'pdf',
    size: 156000,
    url: '#',
    uploadedAt: '2024-03-22T13:45:00Z',
  },
];
...
export const customersApi = {
  ...
  delete: async (id: number): Promise<void> => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify(customers.filter((c) => c.id !== id)),
    );
  },
};
...
export const customerServicesApi = {
  ...
  delete: async (id: number): Promise<void> => {
    ...
    localStorage.setItem(
      STORAGE_KEYS.CUSTOMER_SERVICES,
      JSON.stringify(services.filter((s) => !idsToDelete.has(s.id))),
    );
  },
};
...
export const customerDocumentsApi = {
  ...
  create: async (
    ...
    localStorage.setItem(
      STORAGE_KEYS.CUSTOMER_DOCUMENTS,
  ...
  delete: async (id: number): Promise<void> => {
    ...
    localStorage.setItem(
      STORAGE_KEYS.CUSTOMER_DOCUMENTS,
      JSON.stringify(documents.filter((d) => d.id !== id)),
    );
  },
  upload: async (
